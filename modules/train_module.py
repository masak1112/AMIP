...
class TrainModule(L.LightningModule):
    def __init__(self,
        ...
        self.n_surface = len(self.surface_variables)
        self.n_diagnostic = len(self.diagnostic_variables)
    ...
    def predict(self, batch):
        ...
        i_plot = 0
        plot_keys = ['2m_temperature', 'geopotential', 'PRATEsfc_24h', 'u_component_of_wind', 'temperature', 'specific_humidity']
        # init plot_dict
        pred_feat_dict = {}
        target_feat_dict = {}
        ...
        for t in range(nt):
            ...
            surface_pred_decoded, multilevel_pred_decoded, diagnostic_pred_decoded = disassemble_input(y_last, nsurface = self.n_surface, ndiagnostic= self.n_diagnostic , nlevels=self.nlevels) #nsurface=6, ndiagnostic=15, nlevels=13,
