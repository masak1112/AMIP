...
srun python bias.py --config=$config_file --checkpoint="/project/pedramh/ayz/AMIP_logs/SI_X_forcings_42_2026-04-27T12-12-33/model_epoch=29.ckpt" --description="ep_29_forcing"