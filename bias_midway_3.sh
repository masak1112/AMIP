...
srun python bias.py --config=$config_file --checkpoint="/project/pedramh/ayz/AMIP_logs/SI_X_forcings_42_2026-04-28T09-32-30/model_epoch=35.ckpt" --description="ep_35_forcing"