...
config_file=configs/SI_midway.yaml --checkpoint="/project/pedramh/ayz/AMIP_logs/SI_X_lowres_10_churn_42_2026-04-22T20-37-39/model_epoch=32.ckpt" --description="ep_32"
