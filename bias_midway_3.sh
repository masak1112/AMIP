...
srun python bias.py --config=$config_file --checkpoint="/project/pedramh/ayz/AMIP_logs/SI_X_forcings_42_2026-04-29T10-20-13/model_epoch=05.ckpt" --description="ep_05_forcing"