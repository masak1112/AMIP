...
BIAS_LOGS = "/glade/derecho/scratch/ayz/AMIP_logs/SI_Latent_DiT_VAE_42_2026-04-07T19-05-07/bias_logs_VAE/"
downsample = False

def plot_biases(base_path, variable_type, variable_name, variable_type2, variable_index, bias_logs, level=0):
    ...
    with xr.open_dataset(path) as ds:
        ...
        if variable_type2 == "multilevel": # climatologies are saved with increasing pressure levels
    ...
    if variable_type2 == "multilevel":
        model_climatology = model_climatology[level] # model predictions are at decreasing pressure levels
...
plot_biases(BASE_PATH, "prognostic", "geopotential", "multilevel", 3, BIAS_LOGS, -10)
plot_biases(BASE_PATH, "prognostic", "temperature", "multilevel", 0, BIAS_LOGS, -6)
plot_biases(BASE_PATH, "prognostic", "specific_total_water", "multilevel", 4, BIAS_LOGS, -6)
plot_biases(BASE_PATH, "prognostic", "u_component_of_wind", "multilevel", 1, BIAS_LOGS, -13)
